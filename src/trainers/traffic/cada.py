...
class ConditionalAdversarialTrainer:
    ...
    def train(self, epoch):
        ...
        for e in range(epoch):
            ...
            for i, (target_data, _) in enumerate(self.data_loader):
                ...
                discriminator_loss = self._training_discriminator(target_data, batch_size)
                classifier_loss = self._training_classifier(batch_size)
                target_encoder_loss = self._training_target_encoder(target_data, batch_size)
    ...
    def validate(self, e):
        ...
        for i, (target_data, target_labels) in enumerate(self.validate_data_loader):
            ...
            accuracy.append(100 * (target_preds == target_labels).sum().item() / target_preds.size()[0])
    ...
    def _training_classifier(self, batch_size):
        ...
        classifier_loss = self.classifier_criterion(source_preds, random_labels)
